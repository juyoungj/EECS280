...
class LinkedNodeClass
{
    ...
    private:
        ...
        //Will point to the node that comes before this node
        //in the data structure. Will be NULL if this is the first node.

        T nodeVal; //The value contained within this node
        
        LinkedNodeClass< T > *nextNode; 
        //Will point to the node that comes after this node in the data
        //structure. Will be NULL if this is the last node.
    ...
    public:
        ...
        LinkedNodeClass(
            ...
            const T &inVal, //this value to be contained in this node
            LinkedNodeClass< T > *inNext //Address of node comes after this
            );
